...
void UCPP_Gauntlet_MoveOverPoints::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
	...
	DrawDebugSphere(GetWorld(),PointsToReach[CurrentIndex].GetLocation(),10,10,FColor::Yellow );
	DrawDebugSphere(GetWorld(),PointsToReach[NextIndex].GetLocation(),10,10,FColor::Green );
